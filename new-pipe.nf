...
process extractSplits {
  ...
  python !{baseDir}/RapidSky/splitterExtract.py --rawTimes --skipSeq 1 -l !{params.dir}/RFFileSplitter.log -d !{params.dir}/!{dfile} -b !{params.dir}/RFDatabase.xml -m !{params.methodsDir}
  '''
}
